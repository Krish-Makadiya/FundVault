...
const page = () => {
    ...
    return (
        <div className="w-[40%] mx-auto md:text-[30px] text-[24px] text-center text-white flex flex-col my-20 items-center gap-10">
            <p>Log in to connect with your fans and fuel your success!</p>
            <div className="flex flex-col gap-3">
                <button className="w-[500px] flex justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-3 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg
                ...
                <button
                    ...
                    className="w-[500px] flex justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-3 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg
                        className="h-6 w-6 mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 73 73"
