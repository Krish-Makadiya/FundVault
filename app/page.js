                ...
                <>
                    <div className="md:h-[90vh] h-[80vh] md:w-[60vw] w-[80vw] mx-auto flex flex-col justify-center items-center gap-10">
                        <p className="md:text-[50px] text-[40px] font-[900] text-center">
                            Empowering Ideas, Fueling Innovation: Fund Dreams,
                            Build Futures!
                        </p>

                        <div className="flex flex-col items-center gap-5">
                            <p className="text-[16px] text-center">
                                "Empowering ideas by providing the funding they
                                need to grow, innovate, and shape the future."
                            </p>
                            {status === "loading" ? (
                                <LoadingPage />
                            ) : (
                                <Link
                                    ...
                                    className="px-5 py-3 flex items-center gap-2 border border-[#ffb703]  text-[#ffb703]  rounded transition-all duration-200 hover:bg-[#ffb703]  hover:text-[#001219] hover:scale-110">
                                    <p>{session ? "Dashboard" : "Start Now"}</p>
                                    <svg
                                ...
                                <div className="flex flex-col items-center gap-5">
                                    ...
                                    <div className="flex flex-col justify-center items-center gap-1">
                                        ...
                                        <p className="text-[14px]">
                                            Get ideas and support from your
                                            fans.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col justify-between md:gap-20 gap-16">
                                <div className="flex flex-col items-center gap-5">
                                    ...
                                    <div className="flex flex-col justify-center items-center gap-1">
                                        ...
                                        <p className="text-[14px]">
                                            Work with others to innovate and
                                            create.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="flex justify-between items-center md:flex-row flex-col gap-20">
                            <div className="md:w-[30%] w-[90%] text-center flex flex-col items-center gap-5">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <p>
                                        Mark, a digital artist, shared his
                                        portfolio using our platform and gained
                                        a massive following. Within six months,
                                        he secured a steady stream of
                                        commissions and transitioned into a
                                        full-time creative career.
                                    </p>
                                </div>
                            </div>
                            <div className="md:w-[30%] w-[90%] text-center flex flex-col items-center gap-5">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <p>
                                        Liam, an indie musician, shared his
                                        fundraising campaign on the platform.
                                        With help from fans, he raised $15,000
                                        to produce and release his debut album,
                                        which has now crossed 1 million streams!
                                    </p>
                                </div>
                            </div>
                            <div className="md:w-[30%] w-[90%] text-center flex flex-col items-center gap-5">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <p>
                                        A small nonprofit focused on mental
                                        health used our platform to centralize
                                        their resources and fundraising links.
                                        They not only doubled their donations
                                        but also partnered with mental health
                                        advocates worldwide.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="w-[100%] flex gap-10">
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <p>
                                            Email, call, or complete the form to
                                            learn how FundVault can solve your
                                            messaging problem.
                                        </p>
                                        <div>
                                ...
                                <form
                                    ...
                                    <div className="w-full flex justify-between">
                                        <input
                                            ...
                                            required
                                            className="w-[48%] text-[white] px-3 py-2 rounded-sm bg-[#212234] placeholder:text-[gray]"
                                        />
                                        <input
                                            type="text"
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full text-[white] px-3 py-2 rounded-sm bg-[#212234] placeholder:text-[gray]"
                                    />
                                    <textarea
                                        name=""
                                        id=""
